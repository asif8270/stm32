...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  uint32_t pinState = HAL_GPIO_ReadPin(GPIOA, readLevel_Pin);
	  if (pinState == 0)
	  {
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin : readLevel_Pin */
  GPIO_InitStruct.Pin = readLevel_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(readLevel_GPIO_Port, &GPIO_InitStruct);
